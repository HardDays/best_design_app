...
class DataProvider {
  ...
  static List<String> careTitles = [
    ...
    'July is Book Month',
    'August is Pampering Month',
    'September is Travel of Mind/Body/Soul Month',
    'October is Satisfy Sweet Tooth Month',
    'November is Little Things to Make Us Happy Month',
 ...
 static List<List<CareAffirmation>> careAffirmamtions = [
  ...
  CareAffirmation(id: 'bf4113a3-34cd-4076-8436-143b204ebedc', title: 'Give hugs', month: 5),
    ],
    [
  ...
  CareAffirmation(id: 'beffe823-cd75-464b-e3c8-7d027ed07a80', title: 'Do a podcast', month: 6),
    ],
    [
  ...
  CareAffirmation(id: '43212811-b6ec-4251-32a1-87117127ba31', title: 'Dedicate a book', month: 7),
    ],
    [
...
CareAffirmation(id: '9580407f-51be-42dc-9b39-fa0c54406d73', title: 'Go on a yoga/meditation retreat', month: 9),
  ...
  CareAffirmation(id: 'e148c78d-eb11-1480-b59e-22b64b1b1e43', title: 'Try cloud gazing', month: 9),
    ],
    [
  ...
  CareAffirmation(id: 'fa9d99d9-e8b5-49b5-8535-275f35315baa', title: 'Buy chocolate covered strawberries', month: 10),
  ...
  CareAffirmation(id: '55ea4c9b-b9e2-4e14-aa0a-db852f52adc4', title: 'Indulge in srawberries with whip cream', month: 10),
  CareAffirmation(id: '637ef927-eb5e-4694-bf7b-2406d8fed7d5', title: 'Drink hot cocoa', month: 10),
  CareAffirmation(id: '237af8e7-ef3e-16b4-bc75-3406d1fcd7b2', title: 'Try gummy vitamins', month: 10),
    ],
    [
 CareAffirmation(id: '83753878-180f-450c-b47c-ad3e326726fd', title: 'Drink hot chocolate with whip cream', month: 11),
  ...
  CareAffirmation(id: '21748e33-1412-3313-822a-5e0238e3f3b8', title: 'Dance like a kid', month: 11), 
  CareAffirmation(id: '21748e33-1412-3313-822a-5e0238e3f3b1', title: 'Laugh like a kid', month: 11), 
  CareAffirmation(id: '21748e33-1412-3313-822a-5e0238e3f3b2', title: 'Try skipping', month: 11), 
  CareAffirmation(id: '21748e33-1412-3313-822a-5e0238e3f3b3', title: 'Hug your pet', month: 11), 
  CareAffirmation(id: '21748e33-1412-3313-822a-5e0238e3f3b4', title: 'Try karaoke', month: 11), 
    ],
    [
  ...
  BucketIdea(id: '08cab255-040f-4e67-b9aa-87f0d7b789db', title: 'Swim in the world\’s largest pool in San Alfonso del Mar resort in Chile'),
  ...
  BucketIdea(id: 'a57a70dd-9b7e-4f7c-b69d-c2fde902344f', title: 'Eat a Beignet at Cafe Du Monde'),
  ...
  static List<PositiveItem> positiveItems = [];
  static Map<String, PositiveItem> idPositiveItems = {};
  ...
  static Future init() async {
    ...
    MainAPI.getPositiveItems().then(
      (items) {
        if (items != null) {
          for (var item in items){
            idPositiveItems[item.positiveAffirmation.id] = item;
          }
        } else {
  ...
  static void logout(){
    ...
    Database.setPositiveItems(positiveItems);
  ...
  static Future<bool> createReport(Report report) async {
    var res = await MainAPI.createReport(report);
    return res == true;
  }
