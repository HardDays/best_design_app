...
class CalendarItem {
  ...
  factory CalendarItem.fromJson(Map<String, dynamic> json) {
    return CalendarItem(
      id: json['id'],
      beginDate: json['begin_date'] != 'null' ? DateTime.parse(json['begin_date']) : null,
      endDate: json['end_date'] != 'null' ? DateTime.parse(json['end_date']) : null,
      endMode: json['end_mode'],
      alertTime: json['alert_time'] != 'null' ? TimeOfDay.fromDateTime(DateTime.parse(json['alert_time'])) : null,
